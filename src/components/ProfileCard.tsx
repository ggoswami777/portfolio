...
const ProfileCard = () => {
  ...
  return (
    /* CHANGE: Removed 'bg-black' and added 'bg-bg-primary text-text-primary' */
          ...
          {!showGame ? (
            ...
            >
              ...
              <div className="absolute top-6 right-6 flex gap-2.5">
                {/* CHANGE: Added theme-aware hover states */}
                <button className="h-9 w-9 flex items-center justify-center rounded-lg border border-border-dashed hover:bg-text-primary hover:text-bg-primary transition-all duration-300 cursor-pointer group">
                  <svg viewBox="0 0 24 24" className="h-4.5 w-4.5 fill-current opacity-90" aria-hidden="true">
              ...
              <div className="flex flex-col sm:flex-row gap-10 items-center sm:items-start">
                ...
                >
                  ...
                  {/* CHANGE: Replaced bg-white/5 with a theme-aware bg */}
                ...
                <div className="flex-1 text-center sm:text-left pt-1">
                  <div className="flex items-center justify-center sm:justify-start gap-3 mb-1">
                    {/* CHANGE: Removed 'text-white' so it inherits 'text-text-primary' */}
                    <h1 className="text-4xl font-black tracking-tighter uppercase leading-none">
                      Gauravvv
                    </h1>
                    <svg className="w-7 h-7 flex-shrink-0" viewBox="0 0 24 24" fill="#1DA1F2">
                  ...
                  <div className="h-7 mb-4 flex justify-center sm:justify-start items-center">
                    <AnimatePresence mode="wait">
                      <BlurText
                        ...
                        animateBy="letters"
                        direction="bottom"
                        /* CHANGE: Removed hardcoded text-white */
                  ...
                  <div className="flex justify-center sm:justify-start pt-2">
                    <a 
                      ...
                      /* CHANGE: Added hover:text-text-primary */
              ...
              <div className="mt-12 pt-8 border-t border-dashed border-border-dashed">
                {/* CHANGE: Using text-text-primary with opacity */}
